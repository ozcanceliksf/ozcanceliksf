# Hi, I'm Ozcan Celik 👋
IT Security student at Santa Fe College focused on hands-on cybersecurity, ethical hacking, and penetration testing.

---

## 🎯 Current Focus
- Completing **A.S. in IT Security** at Santa Fe College (Expected 2027)
- Practicing CTF challenges on **TryHackMe**, **picoCTF**, and **HackTheBox**
- Building lab repositories for networking, ethical hacking, and security coursework
- Preparing for cybersecurity internship opportunities (CPT Eligible)
...
| 🌍 Global | **Top 20%** |
| 🚪 Rooms Completed | **41** |
| 🎖️ Badges | **7** (Webbed, World Wide Web, cat linux.txt, Blue, Cyber Ready, OWASP Top 10, 3 Day Streak) |

---

## 🖥️ HackTheBox
[![HackTheBox](https://www.hackthebox.com/badge/image/2148999)](https://app.hackthebox.com/profile/2148999)

| Stat | Value |
|------|-------|
| 🏅 Skills | Linux Capabilities · System Exploitation · Web Site Structure Discovery · Network Sniffing · Reconnaissance |
| 🛠️ Tools | Nmap · Metasploit · BurpSuite · Wireshark · Gobuster |
...
**Security:** Nmap · Metasploit · Burp Suite · Steghide · Kali Linux · Gobuster  
...
- 🖥️ [HackTheBox](https://app.hackthebox.com/profile/ozcanceliksf)
